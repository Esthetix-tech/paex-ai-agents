...
allowed_actions:
  - define_pr_ci_validation_checks
  - classify_mechanical_failures
  - classify_semantic_hold_conditions
  - validate_v1_4_readiness
  - require_companion_governance_synchronization
evidence_required:
