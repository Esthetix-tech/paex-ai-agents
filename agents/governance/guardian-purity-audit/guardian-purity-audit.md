...
title: Guardian Purity Audit
description: Draft-only and review-only governance intake specification for assessing Guardian purity risks and preparing human review materials without granting binding veto, conflict resolution or production authority.
layer: governance
...
exemption_scope:
  ...
  - no_formal_guardian_approval
  - no_guardian_conflict_resolution
...
forbidden_actions:
  ...
  - determine_formal_guardian_approval
  - resolve_guardian_conflict_without_review
allowed_actions:
  - review_metadata
...
For Guardian purity audit specifically, this file must not determine formal Guardian approval or resolve Guardian conflicts. It may recommend HOLD, ESCALATE, remediation, human review or Guardian Review only.
name: Guardian Purity Audit
