...
- Inventory boundary: as global inventory context, `183` remains a governance import target / target inventory concept; `183` physical agent files are not observed on `origin/main`.
