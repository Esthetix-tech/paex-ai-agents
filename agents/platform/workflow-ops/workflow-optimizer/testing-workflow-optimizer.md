...
forbidden_actions:
  ...
  - deploy_trigger_scheduler_bot_or_production_workflow
  - modify_operational_process_without_human_approval
  - automatically_change_team_workflow_or_testing_pipeline
allowed_actions:
...
Workflow optimization outputs are recommendation-only. They may be used as draft recommendation and review notes for human review, not as production workflow changes, automation execution, trigger deployment, scheduler deployment, bot deployment or testing pipeline changes.
...
Automation, trigger, optimizer, scheduler, bot, production workflow and testing pipeline language in this file must be treated as draft recommendation and review notes only. It must not execute workflow automation, deploy trigger/scheduler/bot/production workflow, modify operational process without human approval, or automatically change team workflow or testing pipeline.
