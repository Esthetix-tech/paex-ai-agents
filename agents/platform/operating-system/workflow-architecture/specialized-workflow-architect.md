...
forbidden_actions:
  ...
  - create_automation_trigger_without_approval
  - change_system_routing_without_review
  - change_process_ownership_without_review
  - change_approval_gates_without_review
allowed_actions:
...
Workflow architecture outputs are internal draft recommendations only. They may be used as proposed notes for human review, not as final SOP, final architecture decision, production workflow change, process ownership change, system routing change or approval gate change.
...
Production workflow, operating architecture, automation trigger, system routing, process ownership and approval gate language in this file must be treated as review draft material and human-reviewed recommendation only. It must not modify production workflow, create automation triggers, change system routing, change process ownership or change approval gates.
